/**
 * 🚀 SERVIDOR PRINCIPAL - Producción y Desarrollo con Webpay Real
 * 
 * Este servidor conecta con:
 *   - Firebase (base de datos)
 *   - Transbank SDK (Webpay real)
 *   - Cloudinary (imágenes)
 *   - Resend (emails)
 * 
 * Comandos:
 ...
 * 
 * Configuración:
 *   - TRANSBANK_ENV=integration → Webpay de pruebas (por defecto)
 *   - TRANSBANK_ENV=production  → Webpay producción (requiere credenciales)
 */
